            ...
            <table class="tg">
                ...
                <tr>
                    <td><input class="form-control" type="date"
                               value="<?php date_default_timezone_set('Europe/Warsaw'); echo date('Y-m-d'); ?>"
                               readonly>
                    </td>
                    <td><input class="form-control" type="date" name="expired_at" required></td>
                </tr>
            </table>
            <br/>
            <div class="zgoda">
                <input type="checkbox" id="cbx" style="position: absolute;z-index: -1;" required>
